 ...
 */
export async function renderZoneMap(polygon, pilots, opts = {}) {
    var _a, _b, _c;
    const width = (_a = opts.width) !== null && _a !== void 0 ? _a : 700;
    const height = (_b = opts.height) !== null && _b !== void 0 ? _b : 460;
    const padding = (_c = opts.padding) !== null && _c !== void 0 ? _c : 0.3;
