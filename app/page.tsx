  ...
  return (
    <main className="mx-auto flex min-h-[80vh] max-w-3xl flex-col items-center justify-center gap-6 px-6 text-center">
      ...
      <p className="max-w-xl text-lg text-slate-600">
        Générez automatiquement votre dossier de déclaration préfectorale de vol de drone : le
        Cerfa 15476*04 rempli et vos fiches de zones de vol, prêts à envoyer.
      </p>
      <Link
        href="/login"
